...
<body>
	<div class="container-fluid">
		...
		<div class="col-12 shadow" id="invoice">
			...
			$invoice_rs = Database::search("SELECT * FROM `invoice` WHERE `place_place_id`='".$place_id."' AND `customer_customer_id`='".$uid."' ORDER BY `issuedate` DESC LIMIT 1");
						...
						<div class="row align-content-center">
							...
							<div class="offset-7 col-4 text-end" style="position: absolute;">
								...
								<div class="col-12" style="opacity: 0.8;">
									<span><?php echo $_SESSION["u"]["fname"] . " " . $_SESSION["u"]["lname"] ?></span>
									<br />
									<span><?php echo $_SESSION["u"]["address"] ?></span>
									<br />
